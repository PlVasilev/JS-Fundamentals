function wikiParser(input) {
    ...
    //$(input).html(formatted); // замени в "wiki" съдържанието с форматирания текст като html
    $(input).replaceWith(formatted); // замени в "wiki" съдържанието с форматирания текст
}